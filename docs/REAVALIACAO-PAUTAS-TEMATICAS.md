# Reavaliação global — pautas temáticas, listas e capacidade variável
...
| Recorte | Resultado | Capacidade |
| --- | --- | ---: |
| Rm 16.1-23 | `nt2-romanos-saudacoes`: associa pessoas às descrições dadas na própria carta; Rm 16.24 não foi usado. | 2–6 |
| 1Co 12.4-31 | `nt2-1corintios-dons-corpo`: diversidade de dons e membros, sem completar listas externamente. | 2–6 |
| 1Co 15.1-11 | `nt2-1corintios-testemunhas-ressurreicao`: sequência que o próprio capítulo declara. | 2–6 |
| Gl 5.16-26 | `nt2-galatas-carne-espirito`: obras e fruto mantidos como listas do texto. | 2–6 |
| Ef 6.10-20 | `nt2-efesios-armadura`: associações explícitas da metáfora, sem transformar referências ao AT em fatos adicionais. | 2–6 |
| 1Tm 3.1-15 | `nt2-1timoteo-liderancas`: qualificações organizadas pelos grupos nomeados. | 2–6 |
| 1Ts 5.12-28 | `nt2-1tessalonicenses-exortacoes`: destinatários e ações das exortações finais. | 2–6 |
| Hb 11 | `nt2-hebreus-testemunhos-fe` liberada; os 25 fatos continuam limitados ao que Hebreus declara. | 2–12 |
| 2Jo 1-13 | `nt2-2joao-verdade-hospitalidade`: remetente, destinatária textual, ensino sobre acolhida e plano de visita; interpretação comunitária permanece em documentação, não no gabarito. | 2–4 |
| Tg 3.1-18 | `nt2-tiago-lingua-sabedoria`: comparações da língua e características da sabedoria. | 2–6 |
| Ap 6 | `nt2-apocalipse-selos`: cores, objetos, nomes e acontecimentos dos seis primeiros selos. | 2–6 |
| Ap 13 | `nt2-apocalipse-duas-bestas`: origens, características, marca e número, sem identidade histórica. | 2–6 |
| Ap 15.5–16.21 | `nt2-apocalipse-tacas`: destinos e efeitos explícitos das taças, sem cronologia externa. | 2–6 |
| Ap 20 | `nt2-apocalipse-mil-anos-juizo`: sequência textual, sem escolher sistema milenar. | 2–6 |

## Recortes narrativos antes limitados por 25 cartas
...
| Recorte | Resultado individual e impedimento restante |
| --- | --- |
| Rm 1.1-15; 6–8; 12–14; 15.1-13 | Permissão temática considerada; não autorados porque alternativas para teses/analogias produziriam afirmações teológicas falsas, não por falta de ligação causal. |
| 1Co 1; 8–11; 13–14 | Não autorados: normas e argumentos exigiriam distratores doutrinários; 1Co 12 e 15 receberam pautas delimitadas próprias. |
| 2Co 7; 10; 13 | Não autorados: dados autobiográficos insuficientes para quatro campos, e a defesa/exortação não admite alternativas factuais seguras. |
| Gl 6 | Conclusão e exortações não oferecem quatro campos com cinco fatos independentes; Gl 5 agora possui pauta temática. |
| Ef 1–5 | Argumentos/exortações mantidos sem pauta por risco dos distratores; a lista factual da armadura foi autorada. |
| Cl 3; 4 | Cl 3 não oferece alternativas factuais seguras; Cl 4 permanece consolidado documentalmente com Efésios/Filemom, sem afirmar viagem comum incerta. |
| 1Ts 1; 3.11-13; 4 | Não autorados por falta de quatro campos factuais seguros; 1Ts 5 agora possui pauta temática. |
| 2Ts 2.13-17; 3.6-18 | Não autorados: 2Ts 2 preserva questões interpretativas e 2Ts 3 não sustenta quatro campos com alternativas seguras, mesmo aceitando lista. |
| 1Tm 1; 4–6 | Listas foram aceitas em princípio; os blocos misturam advertência e normas cujos distratores seriam afirmações pastorais falsas. 1Tm 3 foi autorado. |
| 2Tm 3; 4.1-8 | 2Tm 3 combina descrição futura, perseguidores e biografia sem quatro campos delimitáveis; Janes/Jambres não foram completados externamente. 4.1-8 continua insuficiente em fatos não equivalentes. |
| Tt 1; 3 | Tt 1 sobrepõe qualificações já cobertas em 1Tm 3 e não foi duplicado; Tt 3.12-15 tem menos de cinco unidades úteis após manter pessoas/planos sem inferência cronológica. |
| Hb 13.1-19 | A lista foi aceita em princípio, mas mistura deveres e argumento cultual com alternativas doutrinárias inseguras; Hb 11 foi liberado. |
| Tg 1–2; 5.1-12 | Permanecem sem pauta por argumentos/normas com distratores inseguros; Tg 3 recebeu pauta temática explícita. |
| 1Pe 1–2; 3.1-18,20-22; 4.1-5,7-19; 5 | Reavaliados tematicamente. Não oferecem quatro campos factuais seguros sem converter exortações em falsas normas. Mantidas as interpretações aprovadas; 1Pe 3.19 e 4.6 seguem fora. |
