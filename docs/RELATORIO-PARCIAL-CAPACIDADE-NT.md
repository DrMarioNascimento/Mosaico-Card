...
**Fonte:** `data/nt-bank.json`, catálogo `checkpoint-105-marcos-13-inventario`
**SHA-256 do snapshot:** `6f5a801a55e8f7656f2773d52dd874916181f28cdd90feef0154615eafe44f02`
**Commit-base do snapshot:** `f36849411735ec40edba28f37fbefab73a0412c9`
**Reprodução:** `node tools/report-nt-capacity.mjs`

## Unidades contadas e limites

- **Pautas/IDs:** 333; 333 estão elegíveis. Um sorteio retorna exatamente uma pauta.
- **Pistas/cartas:** 6265; há 6229 strings de pista exatamente distintas.
- **Fatos semanticamente únicos:** não verificados. Similaridade automatizada não prova identidade ou independência factual.
- **Histórias/episódios:** sem contagem. O banco não possui agrupamento canônico que relacione IDs paralelos, complementares, temáticos ou referentes à mesma história; portanto, 333 IDs não equivalem a 333 histórias independentes.
...
- Mc 12 conserva fechamento ordinário. Mc 13 foi inventariado integralmente após consulta efetiva; restam por limite somente 13.28-31 e 13.32-37 antes de Mc 14. Mc 11.26 permanece pendência textual isolada, junto de Mc 7.16, 9.44 e 9.46.
