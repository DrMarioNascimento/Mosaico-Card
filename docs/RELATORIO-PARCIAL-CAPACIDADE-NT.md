...
**Fonte:** `data/nt-bank.json`, catálogo `checkpoint-104-marcos-12-remanescentes`
**SHA-256 do snapshot:** `ece848ae9706276c8e34cb27537d43afbc2e1aeb0479ee3d09ae74aa50193074`
**Commit-base do snapshot:** `3a7d1ab74019e6d8395da6a9be982275cc35a7e5`
**Reprodução:** `node tools/report-nt-capacity.mjs`

## Unidades contadas e limites

- **Pautas/IDs:** 329; 329 estão elegíveis. Um sorteio retorna exatamente uma pauta.
- **Pistas/cartas:** 6210; há 6177 strings de pista exatamente distintas.
- **Fatos semanticamente únicos:** não verificados. Similaridade automatizada não prova identidade ou independência factual.
- **Histórias/episódios:** sem contagem. O banco não possui agrupamento canônico que relacione IDs paralelos, complementares, temáticos ou referentes à mesma história; portanto, 329 IDs não equivalem a 329 histórias independentes.
...
- Mc 12.35-37 e 12.38-40 foram anexados após reconsulta efetiva. Mc 12.41-44 já estava coberto, e Mc 13 fica integralmente para a próxima tarefa. Mc 11.26 permanece pendência textual isolada, junto de Mc 7.16, 9.44 e 9.46.
