...
Somente as páginas NAA Bible.com 1840 de Mateus 1–4 foram obtidas (HTTP 200; 336.349, 334.120, 329.146 e 351.052 bytes), com leitura restrita a Mt 1.1-17, 2.13-23, 3.1-12 e 4.12-25. A comparação prévia com **251 pautas/4.904 pistas** incluiu as pautas adjacentes de Mateus e o chamado dos pescadores em Marcos, sem harmonizar. Quatro pautas sustentadas foram anexadas: genealogia (23; capacidade 11), Egito/Belém/Nazaré (20; 9), João no deserto/batismo (20; 9) e Galileia/pescadores/curas (21; 10). Citações e listas ficam na forma de Mateus, sem conteúdo do AT ou cronologia externa.

A comparação serializada preservou byte a byte por `JSON.stringify` os 251 objetos anteriores, na mesma ordem, e anexou somente quatro. O banco passa a **255 pautas/1.020 campos/4.988 pistas**, todas elegíveis. Nenhum recorte autorizado ficou pendente; a conclusão documental sobre Mt 1–4 combina as matrizes atuais, mas não declara Mateus completo. Mt 8–9, 14–17 e 26–28 ficam posteriores; Mt 23.14 e dúvidas de 1Co seguem preservados.

## Checkpoint 081 — inventário limitado de Mateus 8–9

Em 13/09/2026, as páginas NAA Bible.com 1840 de Mt 8 e 9 foram obtidas efetivamente (HTTP 200; 97.575 e 98.424 bytes) e lidas verso a verso. A comparação de perguntas, campos, pistas, referências e paralelos partiu dos **255 objetos/4.988 pistas**. Quatro unidades sustentaram pautas novas: leproso (10 pistas; capacidade 4), sogra/seguidores (17; 8), gadarenos/porcos (16; 7) e chamado/mesa/jejum (19; 9). Referências ao AT ficaram somente como elementos do texto de Mateus; relatos paralelos não foram harmonizados nem declarados como a mesma ocasião.

Os 255 objetos anteriores permaneceram serialmente idênticos e na mesma ordem; somente quatro foram anexados. O resultado é **259 pautas/1.036 campos/5.050 pistas**, todas elegíveis. A ficha de Mateus registra decisão por unidade e matrizes concretas para **Mt 8.5-13, 9.27-31, 9.32-34 e 9.35-38**, que permanecem pendentes apenas pelo limite deste lote, sem exclusão ou insuficiência antecipada. Assim, Mt 8–9 não é fechado. Mt 14–17 e 26–28 ficam posteriores; Mt 23.14, dúvidas de 1Co e exclusões definitivas continuam preservados, e o banco não é declarado completo.

## Checkpoint 082 — remanescentes de Mateus 8–9

Em 13/09/2026, as páginas NAA Bible.com 1840 de Mt 8–9 foram novamente obtidas (HTTP 200; 97.575 e 98.424 bytes), com leitura e autoria restritas a 8.5-13, 9.27-31, 9.32-34 e 9.35-38. A comparação contra **259 objetos/5.050 pistas** precedeu quatro pautas: centurião/servo (20 pistas; capacidade 9), dois cegos/casa (12; 5), mudo/reações (7; 3) e multidões/seara (10; 4). Perguntas independentes e mesas pequenas foram aceitas sem piso de 25 pistas, inflação, harmonização ou interpretação externa.

Os 259 objetos anteriores permaneceram serialmente idênticos e na mesma ordem; somente quatro foram anexados. O banco passa a **263 pautas/1.052 campos/5.099 pistas**, todas elegíveis. Com as decisões do checkpoint 081, não resta recorte conhecido na fila específica de Mt 8–9, sem alegar exaustividade futura. Mt 14–17 e 26–28 ficam posteriores; Mt 23.14, dúvidas de 1Co e exclusões definitivas continuam preservados, e o banco não é declarado completo.
...
## Checkpoint 091 — decisão explícita e contextual de Mt 17.21

A consulta efetiva de Mt 17.21 na NAA Bible.com 1840 (HTTP 200; 96.823 bytes) confirmou o texto entre colchetes e a nota sobre manuscritos mais recentes. A pauta `nt2-mateus-menino-fe-mostarda` foi consolidada para responder **“Falta de oração e jejum”** à pergunta sobre a incapacidade dos discípulos, sempre como inferência contextual de 17.19-21: o verso não afirma literalmente que eles não oraram ou jejuaram. A pequenez da fé de 17.20 continua perspectiva literal na pauta, sem ser apresentada como alternativa errada. Como a arquitetura aceita um só `answerId`, não se duplicou o episódio nem se simulou variante funcional.

Dos 288 objetos anteriores, 287 ficaram byte-equivalentes por `JSON.stringify`; somente o objeto identificado foi alterado, com substituição de uma pista e ajustes delimitados de C4, referências e revelação. O catálogo permanece em **288 pautas/1.152 campos/5.566 pistas**. A diretriz geral passa a admitir perspectivas contextuais fundamentadas e compatíveis, sempre reavaliadas individualmente e distinguidas de citações literais. Mt 23.14, 1Co 11.2-16/14.34-36 e Mc 16.9-20 preservam seus estados. Mc 3–4 é o próximo plano, sem autoria neste checkpoint; testes não tornam o banco completo.

## Checkpoint 092 — Mt 23.14 aplicado e 1Co 11 preservado sem inflação

As páginas NAA 1840 de Mt 23 e 1Co 11 foram efetivamente reconsultadas (HTTP 200; 97.507 e 94.162 bytes). Mt 23.14 foi consolidado em `nt2-mateus-ais-juramentos`: exploração das viúvas e longas orações permanecem respectivamente ato denunciado e modo de justificá-lo, com nota de colchetes/manuscritos mais recentes. A pauta recebeu duas pistas, chegando a 17/capacidade 8.

Os três e somente três gabaritos aprovados de 1Co 11.2-16 foram preservados em artefato estruturado, mas não formam pauta porque o contrato exige quatro campos e a decisão proíbe conteúdo adicional. A decisão editorial está resolvida, enquanto a integração é pendência estrutural. Dos 288 objetos, 287 permaneceram byte-equivalentes e somente a pauta de Mt 23 mudou; o banco fica em **288 pautas/1.152 campos/5.568 pistas**. 1Co 14.34-36 continua pendente, variantes funcionais não existem, Mc 3–4 não foi autorado e testes não declaram o banco completo.

## Checkpoint 093 — exclusão de 1Co 14.35 e relatório parcial

A página NAA 1840 de 1Co 14 foi reconsultada (HTTP 200; 95.136 bytes). Somente o item de 14.35 sobre perguntar ao próprio marido/em casa foi excluído editorialmente do jogo; 14.34/36 não o substituem e a pauta existente de 14.1-33,37-40 fica intacta. A decisão não constitui juízo sobre o texto. Os 288 objetos e 5.568 pistas permaneceram serializadamente idênticos; apenas `catalogVersion` avançou.

`tools/report-nt-capacity.mjs` gera o fechamento parcial datado em Markdown e JSON diretamente do banco validado. O snapshot registra SHA-256, commit-base, pistas, strings exatas, IDs elegíveis e ciclos sem reposição para 2–12 jogadores, sem equiparar pauta a história nem declarar fatos semanticamente únicos. 1Co 11 mantém três itens aprovados em pendência estrutural, variantes de Mt 17 não são funcionais, auditorias globais permanecem abertas e Mc 3–4 é a próxima tarefa em nova base. O banco não está completo.

## Checkpoint 094 — inventário integral de Marcos 3–4

As páginas NAA Bible.com 1840 de Mc 3–4 foram obtidas (HTTP 200; 95.002 e 97.761 bytes) e efetivamente lidas verso a verso. A comparação contra 288 pautas/5.568 pistas confirmou Mc 3.1-6 em `nt2-marcos-mao-ressequida` e Mc 4.35-41 em `nt2-tempestade-barco`; quatro unidades de Mc 3 originaram pautas próprias de 14, 18, 18 e 11 pistas. Todas as unidades de ambos os capítulos receberam matriz concreta na ficha de Marcos; Mc 4.1-20, 4.21-25, 4.26-29 e 4.30-34 ficaram sustentadas para continuidade exclusivamente pelo teto de quatro novas pautas.

Os 288 objetos anteriores permaneceram serializadamente idênticos e na mesma ordem; somente quatro foram anexados. O catálogo passa a **292 pautas/1.168 campos/5.629 pistas**, todas elegíveis, com capacidades novas 6, 8, 8 e 5. Não se inferiu identidade por cura, multidão, monte, mostarda ou seguimento genéricos; paralelos só foram reconhecidos onde já documentados por referências. Mt 17.21, Mt 23.14, os três itens estruturais de 1Co 11, a exclusão encerrada de 1Co 14.35 e Mc 16.9-20 permanecem intactos. O banco não está completo.
