...
| Marcos | 58 / 850 | Mc 7.16, 9.44, 9.46 e 11.26 isolados; seis recortes de Mc 12 restam por limite; Mc 13–16.8 posterior | O checkpoint 102 inventariou integralmente Mc 11–12, anexou quatro pautas de Mc 11 e preservou os paralelos como documentos próprios. | **PENDENTE.** Autorar os seis recortes sustentados de Mc 12 antes de abrir Mc 13; pendências textuais exigem decisão própria. **Mc 16.9-20 permanece FORA POR DECISÃO**. |
...
| 1 Coríntios | 10 / 182 | 1Co 2–7 e partes ainda não representadas; integração estrutural de 11.2-16; separadamente 14.34-36 | 1Co 11.2-16 tem exatamente três perguntas aprovadas em artefato estruturado, insuficientes para o contrato de quatro campos sem conteúdo proibido. | **PENDENTE — regra superada** para 2–7. **INTEGRAÇÃO ESTRUTURAL PENDENTE** para 11.2-16. **DECIDIDO SEM CONTEÚDO NOVO** para 14.34-36; somente 14.35 foi excluído editorialmente, sem substituição. |
...
1. **Próximo trabalho independente — Marcos:** inventariar Mc 11–12 antes de qualquer autoria. Mc 7.16, 9.44 e 9.46 permanecem isolados para decisões textuais próprias.
...
## Delta do checkpoint 085 — Mateus 17.22-27

A auditoria global passou a **273 pautas/5.293 pistas**. Duas pautas novas somam 24 pistas; os 271 objetos anteriores ficaram byte-equivalentes por `JSON.stringify`. Mt 17.22-27 recebeu decisão individual, sem presumir que o anúncio semelhante de Mt 16.21 ocorreu na mesma ocasião. Mt 17.21 permanece pendência textual como Mt 23.14, e Mt 26–28 fica para depois. Nenhuma conclusão global foi inferida dos testes.


## Delta do checkpoint 086 — Mateus 26

A auditoria global passou a **277 pautas/5.372 pistas**. Quatro pautas novas somam 79 pistas; os 273 objetos anteriores ficaram byte-equivalentes por `JSON.stringify`. A Ceia, o Getsêmani e a prisão existentes foram comparados sem alteração, e todas as unidades de Mt 26 receberam decisão individual no inventário atual. Mt 27–28 ficam para depois; Mt 17.21 e 23.14 continuam pendências textuais. Nenhuma conclusão global foi inferida dos testes.
...
## Checkpoint 091 — Mt 17.21 resolvido sem duplicar episódio

A decisão explícita sobre Mt 17.21 foi aplicada ao objeto existente `nt2-mateus-menino-fe-mostarda`: um único C4 usa a inferência contextual “Falta de oração e jejum”, com referência 17.19-21 e explicação da nota textual, enquanto a pequenez da fé de 17.20 permanece perspectiva literal em pista/revelação e não aparece como distrator falso. A arquitetura de resposta única foi preservada, sem criar caso duplicado ou suporte amplo de variantes. Dos 288 objetos anteriores, 287 permanecem serializadamente idênticos e somente o objeto consolidado mudou; totais permanecem **288 pautas/5.566 pistas**. Mt 23.14 e as dúvidas de 1Co seguem pendentes; Mc 3–4 é o próximo plano sem autoria agora.
...
## Checkpoint 095 — quatro remanescentes de Marcos 4

A reconsulta e leitura efetiva exclusiva de Mc 4.1-34 sustentou quatro pautas/64 pistas, com capacidades 12, 5, 6 e 5; Mc 4.35-41 permaneceu coberto por `nt2-tempestade-barco`. Os 292 objetos anteriores ficaram serializadamente idênticos, levando o catálogo de **292/5.629 para 296/5.693**. Marcos passa a 31 pautas/426 pistas que citam o livro, sem equiparar IDs a histórias. Mc 3–4 não conserva remanescente conhecido na matriz vigente; as faixas seguintes e as demais auditorias globais continuam pendentes, Mc 16.9-20 continua fora e o banco não está completo. Próximo lote delimitado: Mc 5–6.
