...
const baseCommit = "f36849411735ec40edba28f37fbefab73a0412c9";
...
const report = {
  ...
  remainingAudits: [
    "Mc 13 foi inventariado integralmente; Mc 13.28-31 e 13.32-37 restam por limite antes de Mc 14",
    "Mc 11.26 é pendência textual isolada e não integra perguntas, respostas ou pistas",
