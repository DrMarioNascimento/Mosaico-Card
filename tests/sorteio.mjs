...
assert.equal(bank.elegiveis(8).filter(id => bank.byId[id].deck.maxPlayers === 8).length, 11, "pautas de dezessete ou dezoito cartas usam capacidade oito");
assert.equal(bank.elegiveis(10).filter(id => bank.byId[id].deck.maxPlayers === 10).length, 3, "pautas de 21 ou 22 cartas usam capacidade dez");
