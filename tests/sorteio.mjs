...
assert.equal(bank.elegiveis(8).filter(id => bank.byId[id].deck.maxPlayers === 8).length, 27, "pautas de dezessete ou dezoito cartas usam capacidade oito");
...
assert.equal(limitadasATres.length, 16, "pautas de sete cartas usam capacidade três");
