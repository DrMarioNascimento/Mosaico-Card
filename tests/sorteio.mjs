...
assert.equal(bank.elegiveis(8).filter(id => bank.byId[id].deck.maxPlayers === 8).length, 7, "pautas de dezessete ou dezoito cartas usam capacidade oito");
assert.equal(bank.elegiveis(10).filter(id => bank.byId[id].deck.maxPlayers === 10).length, 2, "pautas de 21 cartas usam capacidade dez");
