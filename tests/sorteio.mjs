...
assert.equal(limitadasASeis.length, 35, "pautas com 13 ou 14 cartas usam capacidade seis");
...
assert.equal(bank.elegiveis(10).filter(id => bank.byId[id].deck.maxPlayers === 10).length, 14, "pautas de 21 ou 22 cartas usam capacidade dez");
