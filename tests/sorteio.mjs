...
assert.equal(bank.elegiveis(8).filter(id => bank.byId[id].deck.maxPlayers === 8).length, 25, "pautas de dezessete ou dezoito cartas usam capacidade oito");
...
assert.equal(limitadasAQuatro.length, 17, "pautas de nove ou dez cartas usam capacidade quatro");
