...
assert.equal(bank.elegiveis(9).filter(id => bank.byId[id].deck.maxPlayers === 9).length, 21, "pautas de dezenove ou vinte cartas usam capacidade nove");
...
assert.equal(limitadasAQuatro.length, 16, "pautas de nove ou dez cartas usam capacidade quatro");
