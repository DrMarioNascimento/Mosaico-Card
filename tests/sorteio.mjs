...
assert.equal(limitadasASeis.length, 31, "pautas com 13 ou 14 cartas usam capacidade seis");
...
assert.equal(bank.elegiveis(7).filter(id => bank.byId[id].deck.maxPlayers === 7).length, 5, "pautas de quinze ou dezesseis cartas usam capacidade sete");
...
assert.equal(limitadasAQuatro.length, 10, "pautas de nove ou dez cartas usam capacidade quatro");
